const galleries = {
  ...
  "andino-led": [
                  {
                    src: "assets/img/galerias/andino/andino-00.webp",
                    title: "Andino Tijeras",
                    text: "Traje inspirado en danza andina para shows syncro."
                  },
                  {
                    src: "assets/img/galerias/andino/andino-01.webp",
                    title: "Andino en evento",
  ...
  "estructuras": [
                    ...
                    {
                      src: "assets/img/galerias/estructuras/estructura-01.webp",
                      title: "Bella Luz",
...
function updateGallery() {
  ...
  galleryText.textContent = item.text || "";
}
...
document.querySelectorAll("[data-gallery]").forEach((item) => {
  item.addEventListener("click", () => {
    openGallery(item.dataset.gallery, item.dataset.index);
  });
});
